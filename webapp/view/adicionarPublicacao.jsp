...
<body class='p-3'>
    ...
    <h5 class="m-0 position-absolute start-50 translate-middle-x text-nowrap"><%=nome%> - <%= titulo %> - Adicionar publicação </h5>
</h1>
...
<div class='d-flex flex-column justify-content-center align-items-center m-0 p-3 w-100'>
 		...
 		<form  action="/ProjetoTCC/api/control?acao=AdicionarPublicacao" method="POST" class='w-75 bg-dark-subtle py-3 px-4 rounded-3 shadow'>
